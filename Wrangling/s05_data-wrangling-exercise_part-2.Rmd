...
#can use select or rename to rename one at time 
...
bfi_edu <-
 psych::bfi %>% 
   mutate(edu = as.factor(education)) #%>% 
   #factor(education, levels, 1 = HS, 2 = finished hs, 3 = some college, 4 = college degree, 5 = graduate degree
```
