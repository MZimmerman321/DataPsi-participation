...
```{r}
alld <-
 left_join(airports, airlines, by = ("name"))
...
alld %>% 
  right_join(weather, by = c("year", "time_hour")) 

View(alld)

```
airlines and airports by name, join flights by carrier, planes by year and tail num, weather by year time hour
